...
wget -qO /etc/accel-ppp.conf ${server_owner}/INSTALL/SSTP/accel.conf && chmod +x /etc/accel-ppp.conf
...
#Download features
wget -qO /usr/bin/ssstp ${server_owner}/INSTALL/SSTP/menu.sh && chmod +x /usr/bin/ssstp
wget -qO /usr/bin/add-sstp ${server_owner}/INSTALL/SSTP/add-sstp.sh && chmod +x /usr/bin/add-sstp
wget -qO /usr/bin/del-sstp ${server_owner}/INSTALL/SSTP/del-sstp.sh && chmod +x /usr/bin/del-sstp
wget -qO /usr/bin/cek-sstp ${server_owner}/INSTALL/SSTP/cek-sstp.sh && chmod +x /usr/bin/cek-sstp
wget -qO /usr/bin/renew-sstp ${server_owner}/INSTALL/SSTP/renew-sstp.sh && chmod +x /usr/bin/renew-sstp
