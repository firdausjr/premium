...
wget -qO /usr/bin/ltp ${server_owner}/INSTALL/IPSEC/menu.sh && chmod +x /usr/bin/ltp
wget -qO /usr/bin/add-l2tp ${server_owner}/INSTALL/IPSEC/add-l2tp.sh && chmod +x /usr/bin/add-l2tp
wget -qO /usr/bin/del-l2tp ${server_owner}/INSTALL/IPSEC/del-l2tp.sh && chmod +x /usr/bin/del-l2tp
wget -qO /usr/bin/add-pptp ${server_owner}/INSTALL/IPSEC/add-pptp.sh && chmod +x /usr/bin/add-pptp
wget -qO /usr/bin/cek-pptp ${server_owner}/INSTALL/IPSEC/cek-pptp.sh && chmod +x /usr/bin/cek-pptp
wget -qO /usr/bin/del-pptp ${server_owner}/INSTALL/IPSEC/del-pptp.sh && chmod +x /usr/bin/del-pptp
wget -qO /usr/bin/renew-pptp ${server_owner}/INSTALL/IPSEC/renew-pptp.sh && chmod +x /usr/bin/renew-pptp
wget -qO /usr/bin/renew-l2tp ${server_owner}/INSTALL/IPSEC/renew-l2tp.sh && chmod +x /usr/bin/renew-l2tp
