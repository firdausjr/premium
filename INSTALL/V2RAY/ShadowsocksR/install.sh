...
Start_SSR(){
	check_pid
	wget -qO /etc/init.d/ssrmu "${server_owner}/INSTALL/V2RAY/ShadowsocksR/go.sh"
...
Install_SSR
wget -qO /usr/bin/sssr ${server_owner}/INSTALL/V2RAY/ShadowsocksR/menu.sh && chmod +x /usr/bin/sssr
wget -qO /usr/bin/ssr ${server_owner}/INSTALL/V2RAY/ShadowsocksR/ssrmu.sh && chmod +x /usr/bin/ssr
wget -qO /usr/bin/add-ssr ${server_owner}/INSTALL/V2RAY/ShadowsocksR/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -qO /usr/bin/del-ssr ${server_owner}/INSTALL/V2RAY/ShadowsocksR/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -qO /usr/bin/renew-ssr ${server_owner}/INSTALL/V2RAY/ShadowsocksR/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
